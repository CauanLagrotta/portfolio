      ...
      <div className="flex flex-col items-center pt-30 pb-10">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-6 sm:gap-10 px-4">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0, x: 0 }}
            transition={{ duration: 0.6 }}
            className="text-gray-300 leading-7 sm:leading-8 max-w-lg sm:max-w-xl md:max-w-2xl px-2 sm:px-0"
          >
            <p className="mb-4">
        ...
        <div className="bg-gray-800 mt-20 pb-10 p-6 sm:p-10 w-[380px] overflow-x-hidden md:w-full md:min-h-screen">
          <SectionSkills />
        </div>
