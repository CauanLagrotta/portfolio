  ...
  return (
    <div className="flex flex-col justify-center items-center pt-25 z-10 mx-auto overflow-hidden relative">
      ...
      <TextAnimate
        ...
        duration={0.9}
        by="word"
        className="text-5xl md:text-7xl font-bold text-white brightness-200"
      >
        Olá, Eu sou
      </TextAnimate>
      <AuroraText
        ...
        speed={2}
        className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent brightness-200 h-20"
      >
        Cauan Lagrotta
      </AuroraText>
